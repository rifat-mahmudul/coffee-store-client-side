...
const AddCoffee = () => {
    ...
    const handleAddCoffee = e => {
        ...
        const coffee = {name, supplier, category, chef, taste, details,};
        console.log(coffee);
    }

    return (
        <div className="max-w-[90%] xl:max-w-[1000px] mx-auto mb-16">
            <Link to='/' className="font-Rancho flex gap-2 items-center mt-8 mb-8 text-xl"><IoArrowBack></IoArrowBack> Back to Home</Link>

            <div className="w-full bg-[#F4F3F0] font-Railway p-10">
